      ...
      <Content>
        ...
        <TextContent>
          <Article>
            제1조(목적)
            <Details>
              이 약관은 DORUS 회사(전자상거래 사업자)가 운영하는 DORUS 사이버
          ...
          <Article>
            제2조(정의){" "}
            <Details>
              ① “몰”이란 DORUS 회사가 재화 또는 용역(이하 “재화 등”이라 함)을
          ...
          <Article>
            ...
            <Details>
              ...
              신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 DORUS
          ...
          <Article>
            ...
            <Details>
              ...
              회원이 부담하는 채무를 기일에 지급하지 않는 경우 3. 다른 사람의
              “몰” 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를
              위협하는 경우 4. “몰”을 이용하여 법령 또는 이 약관이 금지하거나
              공서양속에 반하는 행위를 하는 경우{" "}
            </Details>
            <Details>
          ...
          <Article>
            ...
            <Details>
              ...
              내용을 알기 쉽게 제공하여야 합니다. 1. 재화 등의 검색 및 선택 2.
              받는 사람의 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호)
              등의 입력 3. 약관내용, 청약철회권이 제한되는 서비스, 배송료․설치비
              등의 비용부담과 관련한 내용에 대한 확인 4. 이 약관에 동의하고 위
              3.호의 사항을 확인하거나 거부하는 표시 (예, 마우스 클릭) 5.
          ...
          <Article>
            ...
            <Details>
              ...
              법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다. 1.
              신청 내용에 허위, 기재누락, 오기가 있는 경우 2. 미성년자가 담배,
              주류 등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우 3.
          ...
          <Article>
            ...
            <Details>
              ① 상위 “몰”과 하위 “몰”이 하이퍼링크(예: 하이퍼링크의 대상에는
